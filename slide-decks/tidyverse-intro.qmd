...
## ניקוי נתונים בצעדים עם tidyverse {.center style="text-align: center"}
...
## צעד 1: זיהוי מבנה הנתונים וקריאת השדות הנכונים {.center style="text-align: center"}
...
## צעד 2: יצירת מילון מונחים למשתנים {.center style="text-align: center"}
...
## צעד 3: ניקוי וסטנדרטיזציה של שמות המשתנים {.center style="text-align: center"}
...
## צעד 4: ניצול שמות המשתנים האמיתיים לקבוצות ניתוח {.center style="text-align: center"}
...
## צעד 5: טיפול במשתנים קטגוריאליים עם שמות אמיתיים {.center style="text-align: center"}
...
## סיכום: יתרונות העבודה עם נתונים אמיתיים {.center style="text-align: center"}
...
# חלק 5: טרנספורמציות משתנים בנתונים ארכיאולוגיים
...
## טרנספורמציות Box-Cox {.center style="text-align: center"}

טרנספורמציית Box-Cox היא משפחה של טרנספורמציות עוצמה:
